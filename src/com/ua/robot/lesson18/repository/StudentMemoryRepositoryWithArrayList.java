...
public class StudentMemoryRepositoryWithArrayList {
    public static final int SIZE = 10;
    private final List<Student> students = new ArrayList<>();

    public StudentMemoryRepositoryWithArrayList() {
        fillArrayListWithStudents();
    }
...
//
    public void fillArrayListWithStudents() {
